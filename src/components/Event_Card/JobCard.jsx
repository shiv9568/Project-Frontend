...
const JobCard = ({ job, user,setSelectedClubId }) => {
  ...
  return (
    <div className="w-[100%] relative min-w-[280px] max-h-[290px] cursor-pointer p-7 rounded-lg shadow-custom hover:shadow-customHover shadow-[1px_1px_9px_#bebebe,0px_0px_0px_#ffffff] transition-transform duration-300 hover:translate-y-0 bg-white rounded-3xl">
      <div className="flex items-center gap-3 mb-4">
        <div className="transition-transform duration-300">
          <img
            src={job?.club?.clubLogo || "https://via.placeholder.com/40"}
            alt="Company Logo"
      ...
      {isHeadAndMatch || localStorage.getItem("role")==="Head" && (
